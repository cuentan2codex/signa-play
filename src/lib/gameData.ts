...
export const LEVELS: Level[] = [
  {
    ...
    words: ['MAMÁ', 'PAPÁ', 'SOL', 'MAR', 'DÍA', 'OJO', 'PAN', 'PES'],
    requiredScore: 0,
    unlocked: true,
  },
  {
  ...
  },
  {
    ...
    words: ['FAMILIA', 'ESCUELA', 'AMIGOS', 'LENGUA', 'MANOS', 'MUNDO', 'CORAZÓN'],
    requiredScore: 500,
    unlocked: false,
  },
  {
    ...
    words: ['BUENOS DÍAS', 'GRACIAS', 'POR FAVOR', 'TE QUIERO', 'BIENVENIDO'],
    requiredScore: 1000,
    unlocked: false,
  },
];
